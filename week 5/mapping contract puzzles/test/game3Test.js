...
describe("Game3", function () {
  ...
  it("should be a winner", async function () {
    ...
    let signer1Adr = await signer1.getAddress();
    let signer2Adr = await signer2.getAddress();
    let signer3Adr = await signer3.getAddress();

    // TODO: win expects three arguments
    await game.win(signer1Adr, signer2Adr, signer3Adr);
